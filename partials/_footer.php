<!-- Footer -->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 offset-md-1 footer-contact">
                        ...
                        <p><i class="fas fa-envelope"></i> Email: <a href="#">GamingGreeks@gmail.com</a></p>
                    </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 footer-copyright display-4" style="font-size:25px;">
                        &copy; Copyright 2020 <a href="#"> | GAMING GREEKS</a>
                    </div>
